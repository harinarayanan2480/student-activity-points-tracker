...
class App:
    def __init__(self, root):
        ...
        self.login_button = tk.Button(root, text="Student Login", command=self.student_login, width=20, height=2, font=("Helvetica", 14))
        self.login_button.pack(pady=20)

        self.teacher_button = tk.Button(root, text="Teacher Login", command=self.teacher_login, width=20, height=2, font=("Helvetica", 14))
        self.teacher_button.pack(pady=20)

    def student_login(self):
        self.login_window = tk.Toplevel(self.root)
        self.login_window.title("Student Login")
        self.login_window.geometry("600x400")  # Set login window size

        self.username_label = tk.Label(self.login_window, text="Username:", font=("Helvetica", 12))
        self.username_label.pack(pady=10)
        self.username_entry = tk.Entry(self.login_window, font=("Helvetica", 12))
        self.username_entry.pack(pady=10)

        self.password_label = tk.Label(self.login_window, text="Password:", font=("Helvetica", 12))
        self.password_label.pack(pady=10)
        self.password_entry = tk.Entry(self.login_window, show="*", font=("Helvetica", 12))
        self.password_entry.pack(pady=10)

        self.login_button = tk.Button(self.login_window, text="Login", command=self.validate_student_login, width=15, height=1, font=("Helvetica", 12))
        self.login_button.pack(pady=20)

    def teacher_login(self):
        self.login_window = tk.Toplevel(self.root)
        self.login_window.title("Teacher Login")
        self.login_window.geometry("600x400")  # Set login window size
        ...
        self.login_button = tk.Button(self.login_window, text="Login", command=self.validate_teacher_login, width=15, height=1, font=("Helvetica", 12))
        self.login_button.pack(pady=20)
    ...
    def show_teacher_menu(self, username):
        self.teacher_menu = tk.Toplevel(self.login_window)
        self.teacher_menu.title("Teacher Menu")
        self.teacher_menu.geometry("600x400")  # Set teacher menu size

        self.modify_points_button = tk.Button(self.teacher_menu, text="Modify Activity Points", command=self.modify_activity_points, width=30, height=2, font=("Helvetica", 14))
        self.modify_points_button.pack(pady=20)

        self.add_student_button = tk.Button(self.teacher_menu, text="Add Student", command=self.add_student, width=30, height=2, font=("Helvetica", 14))
        self.add_student_button.pack(pady=20)
        self.show_activity_button = tk.Button(self.teacher_menu, text="Check Student Activity Points", command=self.check_student_activity_points, width=30, height=2, font=("Helvetica", 14))
        self.show_activity_button.pack(pady=20)

    def show_student_menu(self, username):
        self.student_menu = tk.Toplevel(self.login_window)
        self.student_menu.title("Student Menu")
        self.student_menu.geometry("600x400")  # Set student menu size

        self.new_activity_button = tk.Button(self.student_menu, text="Submit New Activity", command=self.submit_new_activity, width=20, height=2, font=("Helvetica", 14))
        self.new_activity_button.pack(pady=20)

        self.show_activity_button = tk.Button(self.student_menu, text="Show Activity Points", command=lambda: self.show_activity_points(username), width=20, height=2, font=("Helvetica", 14))
        self.show_activity_button.pack(pady=20)
    ...
    def add_student(self):
        self.add_student_window = tk.Toplevel(self.teacher_menu)
        self.add_student_window.title("Add Student")
        self.add_student_window.geometry("600x400")  # Set add student window size

        self.student_id_label = tk.Label(self.add_student_window, text="Id:", font=("Helvetica", 12))
        self.student_id_label.pack(pady=10)
        self.student_id_entry = tk.Entry(self.add_student_window, font=("Helvetica", 12))
        self.student_id_entry.pack(pady=10)

        self.student_username_label = tk.Label(self.add_student_window, text="Username:", font=("Helvetica", 12))
        self.student_username_label.pack(pady=10)
        self.student_username_entry = tk.Entry(self.add_student_window, font=("Helvetica", 12))
        self.student_username_entry.pack(pady=10)

        self.student_password_label = tk.Label(self.add_student_window, text="Password:", font=("Helvetica", 12))
        self.student_password_label.pack(pady=10)
        self.student_password_entry = tk.Entry(self.add_student_window, show="*", font=("Helvetica", 12))
        self.student_password_entry.pack(pady=10)

        self.add_student_button = tk.Button(self.add_student_window, text="Add Student", command=self.validate_and_add_student, width=15, height=1, font=("Helvetica", 12))
        self.add_student_button.pack(pady=20)
